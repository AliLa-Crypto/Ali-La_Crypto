  ...
  return (
    <div className="admin-sidebar">
      ...
      <div className="admin-menu d-flex flex-column gap-2">
        <button onClick={() => navigate("/admin/dashboard/users")} className="btn btn-outline-light">👥 Gestione Utenti</button>
        ...
        <button onClick={() => navigate("/admin/dashboard/moderation")} className="btn btn-outline-light">🚩 Moderazione Post</button>
        <button onClick={() => navigate("/admin/dashboard/stats")} className="btn btn-outline-light">📊 Statistiche</button>
      </div>
    </div>
  );
};
