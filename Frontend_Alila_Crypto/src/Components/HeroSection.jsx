...
function HeroSection() {
  return (
    <section className="hero-section bg-dark text-light py-2">
      <Container>
        <Row className="align-items-center">
          <Col xs={12} md={6} className="text-center text-md-start mb-4 mb-md-0">
            ...
            <Button href="#livelli" variant="light" size="lg">Inizia ora</Button>
          </Col>
          <Col xs={12} md={6} className="text-center">
            <img src={logo} alt="Crypto Earth" className="img-fluid hero-img" />
          </Col>
        </Row>
      </Container>
    </section>
